...
[Redis OM .NET][redis-omx-dotnet] | **Redis OM Node.js** | [Redis OM Python][redis-omx-python] | [Redis OM Spring][redis-omx-spring]

<details>
  <summary><strong>Table of contents</strong></summary>

  - 💡 [Redis OM for Node.js](#-redis-omx-for-nodejs)
...
[package-shield]: https://img.shields.io/npm/v/redis-omx?logo=npm
[build-shield]: https://img.shields.io/github/workflow/status/redis/redis-omx-node/CI/main
[license-shield]: https://img.shields.io/npm/l/redis-omx
...
[package-url]: https://www.npmjs.com/package/redis-omx
[build-url]: https://github.com/redis/redis-omx-node/actions/workflows/ci.yml
[license-url]: LICENSE
...
[redis-omx-dotnet]: https://github.com/redis/redis-omx-dotnet
[redis-omx-python]: https://github.com/redis/redis-omx-python
[redis-omx-spring]: https://github.com/redis/redis-omx-spring
